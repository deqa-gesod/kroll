// Real product catalogue, replacing the legacy retail.ts mock list.
// Generated from /shop-products-research.md (15 products, real prices in NOK,
// real product photography stored under /public/images/shop/).
// The cart subsystem (useCart + AddToBagButton + CartDrawer) is product-data
// agnostic, so this file only needs to expose the shape used by ShopGrid.
